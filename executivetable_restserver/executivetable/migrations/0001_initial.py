    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('startup_id', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='executivetable.Startup')),
            ],
        ),
        migrations.CreateModel(
            name='UserProfile',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('connection_id', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='executivetable.Connection')),
                ('startup_receiver_id', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='startup_receiver_id', to='executivetable.Startup')),
                ('startup_sender_id', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='startup_sender_id', to='executivetable.Startup')),
                ('user_receiver_id', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='user_receiver_id', to='executivetable.User')),
                ('user_sender_id', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='user_sender_id', to='executivetable.User')),
            ],
        ),
        migrations.CreateModel(
            name='MessageBoard',
